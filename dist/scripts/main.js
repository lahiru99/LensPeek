...
(() => {
  ...
  // src/scripts/exif-parser.js
  var import_exif_js = __toESM(require_exif());
  function parseExifData(file) {
    return new Promise((resolve) => {
      const reader = new FileReader();
      reader.onload = function(e) {
        const exifData = import_exif_js.default.readFromBinaryFile(e.target.result);
        if (exifData) {
          resolve({
